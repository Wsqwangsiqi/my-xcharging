...
var _default = (_dec = (0, _base.pagify)(), _dec(_class = function (_MyPage) {
  ...
  function _default() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = _default.__proto__ || Object.getPrototypeOf(_default)).call.apply(_ref, [this].concat(args))), _this), _this.pageName = 'user/charging', _this.data = {}, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }
